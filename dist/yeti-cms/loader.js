...
(function () {
    ...
    if (!window[loaderName] && !window.wsiteAsyncLoaderComplete) {
        ...
        document.write('<script class="yeti-script">var UPLOADCARE_LOCALE = "en", UPLOADCARE_AUTOSTORE = true;</script>');
        ...
        loadScript("/yeti-cms/simple-persistence-adapter.mod.js");
